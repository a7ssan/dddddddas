...
client.on('ready',  () => {
  console.log('تم تشغيل :CastleBot ✨  ');
...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`http://www.twitch.tv/Hassan™`);
    }, ms);100000
...
client.login('NTM5OTAyOTI3MjYzNzYwMzg1.DzJHUA.BSA89Ow6S6uba8zBXXwhBDmocL0');
